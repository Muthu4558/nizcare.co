...
import HeroSection from '../components/Aerospace-sector/SectionHeader';
import Introduction from '../components/Aerospace-sector/introduction';
import HotelHealthChallenges from '../components/Aerospace-sector/HotelHealthChallenges';
import HealthPackagesAccordion from '../components/Aerospace-sector/HealthPackagesAccordion';
import WellnessPackages from '../components/Aerospace-sector/WellnessPackages';
import InHouseHealthcare from '../components/Aerospace-sector/InHouseHealthcare';
...
const AerospaceSector = () => {
    ...
    const sectorOptions = [/* your options */];
