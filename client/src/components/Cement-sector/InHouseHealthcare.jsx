            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div data-aos="fade-up" data-aos-delay="100" className="mt-16 text-center">
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                        Nizcare delivers the robust, precision health solutions that secure your cement plant’s human capital. Partner with us to transform high-hazard health risks into a foundation for sustained operational excellence and superior safety.
                    </p>
                </div>
            </div>
        </section>
