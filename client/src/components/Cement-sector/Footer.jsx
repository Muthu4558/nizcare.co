  ...
  return (
    <section className="bg-gradient-to-br from-[#e0f7f4] via-white to-[#f0fcfb] text-center relative overflow-hidden pt-10">
      ...
      <h2
        ...
        data-aos="fade-up"
      >
        Let’s build your workforce <span className="text-teal-600">wellness</span> blueprint today!
      </h2>
      ...
      <div className="bg-[#1f2429] mt-20 py-5 text-white text-sm font-medium">
        Nizcare | Trusted by 100+ Cement Sectors | Health that Serves Hospitality
      </div>
    </section>
  );
};
