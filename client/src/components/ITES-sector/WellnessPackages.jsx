...
import { FaLaptopCode, FaNetworkWired, FaUserTie } from "react-icons/fa";
    ...
    <section className="py-20 px-6">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <h2
          ...
          data-aos="fade-down"
        >
          Beyond the Screen: <span className="text-teal-600">Wellness Add-ons</span> That Work Behind the Code
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {packages.map((pkg, idx) => (
            <div
              ...
              data-aos="fade-up"
              data-aos-delay={200 + idx * 150} // stagger each card
            >
              {/* Image */}
              ...
              <div className="p-6 text-left">
                <h3 className="text-lg md:text-xl font-semibold text-gray-800 mb-4 flex items-center gap-2">
                  {/* {pkg.icon} */}
                  <span className="text-black">{pkg.title}</span>
                </h3>
...
export default WellnessPackagesCards;
