            ...
            <div className="max-w-7xl mx-auto">
                ...
                >
                    <h2 className="text-3xl md:text-4xl font-bold mb-2">
                       Wellness Plugged In: Nizcare’s On-Site Health Hub for {' '} 
                        <span className="text-yellow-400">IT Parks</span>
                        
                    </h2>
                    <p className="text-lg text-white/90 max-w-4xl mx-auto">
                        Nizcare establishes industry-relevant On-Site Health Centres (OHC) at your IT Parks. These centers provide,
                    </p>
                </div>
