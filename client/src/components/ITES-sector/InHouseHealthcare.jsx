            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div data-aos="fade-up" data-aos-delay="100" className="mt-16 text-center">
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                        Nizcare understands that in the IT world, health is performance. We provide the strategic NCD solutions that protect your code, your people, and your bottom line.
                    </p>
                </div>
            </div>
        </section>
