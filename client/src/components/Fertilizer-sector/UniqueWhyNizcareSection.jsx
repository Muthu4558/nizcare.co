      ...
      <div className="max-w-7xl mx-auto space-y-20">
        ...
        >
          ...
          <p className="text-lg font-medium text-gray-700 mb-2">
            Book a Demo by <span className="font-bold text-teal-700">July 31st</span> and Get Your First Wellness Workshop <span className="text-green-600 font-bold">FREE!</span>
          </p>
