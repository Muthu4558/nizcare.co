            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div data-aos="fade-up" data-aos-delay="100" className="mt-16 text-center">
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                        Nizcare delivers the precision health solutions that secure your institution's most vital asset: the health and focus of your educators and innovators. Partner with us to build a smarter, healthier campus.
                    </p>
                </div>
            </div>
        </section>
