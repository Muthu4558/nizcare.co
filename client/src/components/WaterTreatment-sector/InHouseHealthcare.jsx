            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div data-aos="fade-up" data-aos-delay="100" className="mt-16 text-center">
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                        Nizcare delivers the specialized health solutions that secure the health and commitment of the essential workers who manage your water and sanitation infrastructure. Partner with us to mitigate risk and ensure a continuous flow of service.
                    </p>
                </div>
            </div>
        </section>
