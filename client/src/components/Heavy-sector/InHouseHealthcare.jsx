            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div data-aos="fade-up" data-aos-delay="100" className="mt-16 text-center">
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                        Nizcare delivers the rigorous, specialized health solutions that secure your heavy industry operations' most valuable asset: its people. Partner with us to transform occupational risks into a foundation for sustained safety and peak performance.
                    </p>
                </div>
            </div>
        </section>
