...
import heroImage from '../../assets/Heavy-sector-img/cover-img.jpeg';
            ...
            <div className="relative z-10 max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-10 items-center mt-5">
                ...
                >
                    <h1
                        ...
                        data-aos-delay="300"
                    >
                        Wellness That Works as Hard as Your Team.
                    </h1>
                    <p
                        ...
                        data-aos-delay="500"
                    >
                        Wellbeing Solutions Tough Enough for Heavy Industry.
                    </p>
                </div>
                ...
                >
                    ...
                    <div
                        ...
                        data-aos-delay="400"
                    >
                        <p className="hidden md:hidden">Heavy</p>
