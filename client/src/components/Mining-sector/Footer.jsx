  ...
  return (
    <section className="bg-gradient-to-br from-[#e0f7f4] via-white to-[#f0fcfb] text-center relative overflow-hidden">
      ...
      <h2
        ...
        data-aos="fade-up"
      >
      Take the First Step Toward a <span className="text-teal-600">Safer, Healthier</span> Mine.
      </h2>
      ...
      <div className="bg-[#1f2429] mt-20 py-5 text-white text-sm font-medium">
        Nizcare | Trusted by Leading Mining Companies | Workforce Wellness that Drives Productivity
      </div>
    </section>
  );
};
