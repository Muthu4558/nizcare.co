  ...
  return (
    <section className="bg-gradient-to-br from-[#e0f7f4] via-white to-[#f0fcfb] text-center relative overflow-hidden">
      ...
      <h2
        ...
        data-aos="fade-up"
      >
         From ship to shore — let’s empower your maritime teams with <span className="text-teal-600">holistic wellness and care! </span>
      </h2>
      ...
      <div className="bg-[#1f2429] mt-20 py-5 text-white text-sm font-medium">
        Nizcare | Empowering Maritime Workforces | Wellness Across Ship, Shore & Beyond
      </div>
    </section>
  );
};
