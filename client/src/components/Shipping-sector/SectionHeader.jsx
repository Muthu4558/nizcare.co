...
import heroImage from '../../assets/Shipping-sector-img/cover-img.jpeg';
...
const HeroSection = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    district: '',
    city: '',
    sector: 'Ports, Shipping & Maritime',
    usingWellness: '',
    employeeCount: '',
    expectedFeatures: '',
    anythingElse: ''
      ...
      <div className="relative z-10 max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-10 items-center mt-5">
        ...
        >
          ...
          <p
            ...
            data-aos-delay="400"
          >
            Empowering Maritime Teams with Health at Every Port.
          </p>
        </div>
        ...
        >
          ...
          <div
            ...
            data-aos-delay="400"
          >
            <p className="hidden md:hidden">Shipping</p>
