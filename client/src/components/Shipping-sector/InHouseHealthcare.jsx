            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div data-aos="fade-up" data-aos-delay="100" className="mt-16 text-center">
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                        Nizcare delivers the specialized health solutions that secure your maritime assets—both the ships and the people who run them. Partner with us to navigate risk and achieve peak performance.
                    </p>
                </div>
            </div>
        </section>
