      ...
      <div className="max-w-7xl mx-auto space-y-20">
        ...
        >
          ...
          <p className="text-lg font-medium text-gray-700 mb-2">
            🎉 Free On-Site Health Awareness Workshop for your team – exclusively available for the first <span className="font-bold text-teal-700">5 Aerospace or Defense partners</span> this quarter!
          </p>
