  ...
  return (
    <section className="bg-gradient-to-br from-[#e0f7f4] via-white to-[#f0fcfb] text-center relative overflow-hidden">
      ...
      <h2
        ...
        data-aos="fade-up"
      >
        Let’s craft a healthier future for your artisans — <span className="text-teal-600">one check-up at a time!</span>
      </h2>
      ...
      <div className="bg-[#1f2429] mt-20 py-5 text-white text-sm font-medium">
        Nizcare | Empowering Weaving Communities | Strengthening Health, One Thread at a Time
      </div>
    </section>
  );
};
