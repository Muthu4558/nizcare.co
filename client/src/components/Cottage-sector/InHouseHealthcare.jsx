            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div data-aos="fade-up" data-aos-delay="100" className="mt-16 text-center">
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                        Nizcare delivers the specialized health solutions that secure the health and heritage of your cottage industry workers. Partner with us to ensure strong traditions are built by strong, healthy hands.
                    </p>
                </div>
            </div>
        </section>
