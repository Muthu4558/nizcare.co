...
import heroImage from '../../assets/Cottage-sector-img/cover-img.jpeg';
            ...
            <div className="relative z-10 max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-10 items-center mt-5">
                ...
                >
                    <h1 className="text-4xl md:text-5xl font-bold leading-tight">
                        Crafting Wellness for the Cottage Workforce
                    </h1>
                    <p
                        ...
                        data-aos-delay="400"
                    >
                        Stronger Health for the Hands that Build Traditions.
                    </p>
                </div>
                ...
                >
                    ...
                    <div
                        ...
                        data-aos-delay="400"
                    >
                        <p className="hidden md:hidden">Cottage</p>
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className={`w-full py-3 rounded-xl bg-gradient-to-r from-orange-400 to-yellow-400 text-white font-bold shadow-md transition duration-300 hover:scale-105 ${
