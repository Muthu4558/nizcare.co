  ...
  return (
    <section className="bg-gradient-to-br from-[#e0f7f4] via-white to-[#f0fcfb] text-center relative overflow-hidden">
      ...
      <h2
        ...
        data-aos="fade-up"
      >
         From pulp to print — let’s roll out a <span className="text-teal-600">healthier future </span>
        for your paper plant teams with precision wellness!
      </h2>
      ...
      <div className="bg-[#1f2429] mt-20 py-5 text-white text-sm font-medium">
        Nizcare | Empowering Paper Industry Workforces | Wellness Rolled Out from Mill to Market
      </div>
    </section>
  );
};
