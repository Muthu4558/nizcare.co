            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div data-aos="fade-up" data-aos-delay="100" className="mt-16 text-center">
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                        Nizcare delivers the specialized health solutions that secure your paper mill’s most valuable asset: its skilled people. Partner with us to transform occupational risks into a foundation for sustained operational strength and compliance.
                    </p>
                </div>
            </div>
        </section>
