            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div data-aos="fade-up" data-aos-delay="100" className="mt-16 text-center">
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                        Nizcare delivers the specialized health solutions that secure your metal plant's most valuable asset: its people. Partner with us to transform health risks into a foundation for sustained safety and operational strength.
                    </p>
                </div>
            </div>
        </section>
