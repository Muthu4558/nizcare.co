...
import heroImage from '../../assets/Metal-sector-img/cover-img.jpeg';
            ...
            <div className="relative z-10 max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-10 items-center mt-5">
                ...
                >
                    <h1 className="text-4xl md:text-5xl font-bold leading-tight">
                        Forging Stronger Teams Through Health
                    </h1>
                    <p
                        ...
                        data-aos-delay="400"
                    >
                        Where Metal Meets Wellness – Powering Productivity Through Preventive Care.
                    </p>
                </div>
