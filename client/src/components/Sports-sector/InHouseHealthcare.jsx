            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div data-aos="fade-up" data-aos-delay="100" className="mt-16 text-center">
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                        Nizcare delivers the precision health solutions that secure your team's competitive edge and the longevity of your staff. Partner with us to transform health from a risk into a fundamental performance factor.
                    </p>
                </div>
            </div>
        </section>
