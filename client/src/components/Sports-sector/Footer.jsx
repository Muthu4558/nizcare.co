  ...
  return (
    <section className="bg-gradient-to-br from-[#e0f7f4] via-white to-[#f0fcfb] text-center relative overflow-hidden">
      ...
      <h2
        ...
        data-aos="fade-up"
      >
         From stables to stadiums — let’s fuel your frontline with <span className="text-teal-600">wellness that strengthens every role and routine!</span>
      </h2>
      ...
      <div className="bg-[#1f2429] mt-20 py-5 text-white text-sm font-medium">
        Nizcare | Supporting Sports & Livestock Workers | Wellness That Powers Every Step & Stride
      </div>
    </section>
  );
};
