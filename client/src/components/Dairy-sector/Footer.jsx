  ...
  return (
    <section className="bg-gradient-to-br from-[#e0f7f4] via-white to-[#f0fcfb] text-center relative overflow-hidden">
      ...
      <h2
        ...
        data-aos="fade-up"
      >
         From milking to monitoring — let’s support your dairy teams with <span className="text-teal-600">wellness that's tailored to every shift and season!</span>
      </h2>
      ...
      <div className="bg-[#1f2429] mt-20 py-5 text-white text-sm font-medium">
        Nizcare | Empowering Dairy & Livestock Workers | Wellness That Nourishes Your Workforce
      </div>
    </section>
  );
};
