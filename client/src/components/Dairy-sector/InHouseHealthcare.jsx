            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div data-aos="fade-up" data-aos-delay="100" className="mt-16 text-center">
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                        Nizcare delivers the specialized health solutions that secure your dairy operation’s most valuable assets: the health of your animals and the strength of your workforce. Partner with us to mitigate risk and ensure a continuous supply of quality products.
                    </p>
                </div>
            </div>
        </section>
