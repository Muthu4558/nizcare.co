            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div data-aos="fade-up" data-aos-delay="100" className="mt-16 text-center">
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                        Nizcare delivers the robust, specialized health solutions that secure your petroleum operations' most valuable asset: its people. Partner with us to transform health risks into a foundation for sustained safety and peak performance.
                    </p>
                </div>
            </div>
        </section>
