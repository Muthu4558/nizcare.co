            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div data-aos="fade-up" data-aos-delay="100" className="mt-16 text-center">
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                        Nizcare understands that quality assurance starts with human health. We provide the strategic NCD solutions that protect your people, your product quality, and your long-term compliance record.
                    </p>
                </div>
            </div>
        </section>
