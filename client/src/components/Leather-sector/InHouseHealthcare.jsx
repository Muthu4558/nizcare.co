      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div data-aos="fade-up" data-aos-delay="100" className="mt-16 text-center">
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Nizcare delivers the rigorous, specialized health solutions that secure your leather enterprise’s human capital. Partner with us to transform occupational and chronic health risks into a foundation for sustained ethical compliance and production excellence.
          </p>
        </div>
      </div>
    </section>
