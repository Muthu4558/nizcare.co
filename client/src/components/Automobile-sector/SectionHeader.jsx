...
import heroImage from '../../assets/Automobile-sector-img/cover-img.jpeg';
...
const HeroSection = () => {
    ...
    // ✅ Match AOS config from Aerospace component
    useEffect(() => {
        AOS.init({
            duration: 1200,
            once: true,
            ...
            <div className="relative z-10 max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-10 items-center mt-5">
                ...
                >
                    <h1 className="text-4xl md:text-5xl font-bold leading-tight">
                        Built to Perform. Designed to Care.
                    </h1>
                    <p
                        ...
                        data-aos-delay="400"
                    >
                        Precision Wellness for India’s Auto Workforce.
                    </p>
                </div>
                ...
                >
                    ...
                    <div
                        ...
                        data-aos-delay="400"
                    >
                        <p className="hidden md:hidden">Automobile</p>
