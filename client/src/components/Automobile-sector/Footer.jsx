  ...
  return (
    <section className="bg-gradient-to-br from-[#e0f7f4] via-white to-[#f0fcfb] text-center relative overflow-hidden">
      ...
      <h2
        ...
        data-aos="fade-up"
      >
         Let’s build a culture of well-being across your <span className="text-teal-600">technicians, engineers, and plant managers! </span>
      </h2>
      ...
      <div className="bg-[#1f2429] mt-20 py-5 text-white text-sm font-medium">
        Nizcare | Powering the People Behind the Machines | Precision Health for Auto Teams
      </div>
    </section>
  );
};
