            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div data-aos="fade-up" data-aos-delay="100" className="mt-16 text-center">
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                        Nizcare delivers the precision health solutions that ensure your automotive workforce remains engaged, safe, and ready to meet production targets. Partner with us to mitigate risk and accelerate performance.
                    </p>
                </div>
            </div>
        </section>
