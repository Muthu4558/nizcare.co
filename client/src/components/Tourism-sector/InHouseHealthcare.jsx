            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div data-aos="fade-up" data-aos-delay="100" className="mt-16 text-center">
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                        Nizcare delivers the specialized health solutions that secure your travel team's most valuable asset: their energy and resilience. Partner with us to mitigate risk and ensure every journey is a success.
                    </p>
                </div>
            </div>
        </section>
