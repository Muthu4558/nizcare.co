            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div data-aos="fade-up" data-aos-delay="100" className="mt-16 text-center">
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                        Nizcare delivers the precision health solutions required to protect your banking team's most valuable assets: their health and their focus. Partner with us to mitigate risk and secure your returns.
                    </p>
                </div>
            </div>
        </section>
