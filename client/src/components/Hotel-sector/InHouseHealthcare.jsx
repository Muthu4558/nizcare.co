      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div data-aos="fade-up" data-aos-delay="100" className="mt-16 text-center">
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Nizcare understands that your competitive edge lies in your team’s well-being. Partner with us to transform high-pressure health risks into a foundation for consistent service excellence and lasting profitability.
          </p>
        </div>
      </div>
    </section>
