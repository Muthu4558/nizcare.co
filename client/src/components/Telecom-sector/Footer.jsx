  ...
  return (
    <section className="bg-gradient-to-br from-[#e0f7f4] via-white to-[#f0fcfb] text-center relative overflow-hidden">
      ...
      <h2
        ...
        data-aos="fade-up"
      >
         From towers to tickets — let’s power up your telecom teams with <span className="text-teal-600">wellness that connects every role and routine!</span>
      </h2>
      ...
      <div className="bg-[#1f2429] mt-20 py-5 text-white text-sm font-medium">
        Nizcare | Empowering Telecom Workforces | Wellness That Connects Your Teams
      </div>
    </section>
  );
};
