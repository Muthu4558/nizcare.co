...
const packages = [
  {
    ...
    icon: <FaBroadcastTower className="text-2xl text-orange-400" />,
    benefits: [
  ...
  },
  {
    ...
    icon: <FaHeadset className="text-2xl text-orange-400" />,
    benefits: [
  ...
  },
  {
    ...
    icon: <FaSalesforce className="text-2xl text-orange-400" />,
    benefits: [
