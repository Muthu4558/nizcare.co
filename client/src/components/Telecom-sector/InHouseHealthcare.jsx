            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div data-aos="fade-up" data-aos-delay="100" className="mt-16 text-center">
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                        Nizcare delivers the precision health solutions that secure your telecom network's most critical asset: its people. Partner with us to mitigate risk and ensure a continuous, high-speed connection to health.
                    </p>
                </div>
            </div>
        </section>
